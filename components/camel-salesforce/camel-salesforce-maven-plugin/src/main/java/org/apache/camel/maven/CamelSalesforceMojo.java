...
//            return field.getPicklistValues() != null && !field.getPicklistValues().isEmpty();
        ...
        public Set<Map.Entry<String, Object>> propertiesOf(final Object object) {
            ...
            final Map<String, Object> capitalizedKeys = new HashMap<>();
            for (Map.Entry<String, Object> entry : properties.entrySet()) {
                final String key = StringUtils.capitalize(entry.getKey());
                capitalizedKeys.put(key, entry.getValue());
            }

            return capitalizedKeys.entrySet();
        }
