...
public class NettyProducer extends DefaultAsyncProducer {
    ...
    protected void doStart() throws Exception {
        ...
        if (configuration.isProducerPoolEnabled()) {
            ...
            pool = new GenericObjectPool<ChannelFuture>(new NettyProducerPoolableObjectFactory(this), config);
            ...
            pool = new SharedSingletonObjectPool<ChannelFuture>(new NettyProducerPoolableObjectFactory(this));
            if (LOG.isDebugEnabled()) {
