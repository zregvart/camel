...
public class AbstractAS2TestSupport extends CamelTestSupport {
    ...
    protected CamelContext createCamelContext() throws Exception {
        ...
        configuration.setTargetHostname((String) options.get("targetHostname"));
        configuration.setTargetPortNumber((String) options.get("targetPortNumber"));
        configuration.setClientFqdn((String) options.get("clientFqdn"));
        configuration.setServerPortNumber(Integer.parseInt((String)options.get("serverPortNumber")));
