 ...
 */
package org.apache.camel.component.mongodb3.verifier;
...
public class MongoDbVerifierExtensionTest extends AbstractMongoDbTest {
    ...
    protected MongoDbComponent getComponent() {
        return context().getComponent("mongodb3", MongoDbComponent.class);
    }

    protected ComponentVerifierExtension getExtension() {
        Component component = context().getComponent("mongodb3");
