...
----
[...]
[INFO] --- spring-boot-maven-plugin:1.5.1.RELEASE:run (default-cli) @ camel-example-spring-boot-rest-openapi ---
  .   ____          _            __ _ _
...
The OpenApi documentation is located at: http://localhost:8080/camel/api-doc and can be retrieved with the following command:
